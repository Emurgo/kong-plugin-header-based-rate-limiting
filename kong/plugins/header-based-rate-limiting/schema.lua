...
return {
    ...
    fields = {
	    ...
	    fields = {
                ...
                { redis_timeout_in_milliseconds = { type = "number", required = true, default = 1000 } },
                { redis_max_idle_timeout_in_milliseconds = { type = "number", required = true, default = 1000 } },
                { redis_pool_size = { type = "number", required = true, default = 10 } },
                { default_rate_limit = { type = "number", required = true } },
                { log_only = { type = "boolean", required = true, default = false } },
                { identification_headers = { type = "array", required = true, elements = { type = "string" } } },
